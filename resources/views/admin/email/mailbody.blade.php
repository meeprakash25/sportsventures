...
<body style="box-sizing: border-box;  background-color: #f5f8fa; height: 100%; hyphens: auto; line-height: 1.4; margin: 0; -moz-hyphens: auto; -ms-word-break: break-all; width: 100% !important; -webkit-hyphens: auto; -webkit-text-size-adjust: none; word-break: break-word;">
<style>
            ...
            <table class="content" width="100%" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    <td class="header"
                        ...
                        <a href="{!! $websiteURL !!}"
                           style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #bbbfc3; font-size: 24px; font-weight: bold; text-decoration: none; text-shadow: 0 1px 0 #ffffff;">
                            {!! $websiteName !!}
                        </a>
                    </td>
                </tr>
                        ...
                        <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td class="content-cell"
                                    ...
                                    <p style="box-sizing: border-box; line-height: 1.5em;">
                                        {!! $email_body !!}
                                    </p>
                            ...
                            <tr>
                                <td class="content-cell" align="center"
                                    ...
                                    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; line-height: 1.5em; margin-top: 0; color: #aeaeae; font-size: 12px; text-align: center;">
                                        © {{date('Y')}} <a href="{!! $websiteURL !!}"
                                                           style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #bbbfc3; text-decoration: none; text-shadow: 0 1px 0 #ffffff;">{!! $websiteName !!}</a>.
