                    ...
                    <div class="product-description">
                      <div class="body-area">
                        ...
                        <div class="row justify-content-center">
                          <div class="col-lg-3">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Esewa Key') }} *
                                  </h4>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="{{ __('Esewa Key') }}" name="stripe_key" value="{{ $gs->stripe_key }}" required="">
                          </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                          <div class="col-lg-3">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Esewa Secret') }} *
                                  </h4>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="{{ __('Esewa Secret') }}" name="stripe_secret" value="{{ $gs->stripe_secret }}" required="">
                          </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                          <div class="col-lg-3">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Esewa Text') }} *</h4>

                            </div>
                          </div>
                          <div class="col-lg-6">
                            <textarea class="input-field" name="stripe_text" placeholder="{{ __('Esewa Text') }}">{{ $gs->stripe_text }}</textarea>
                        ...
                        <div class="row justify-content-center">
                          <div class="col-lg-3">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Khalti Email') }} *
                                  </h4>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="{{ __('Khalti Email') }}" name="paypal_business" value="{{ $gs->paypal_business }}" required="">
                          </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                          <div class="col-lg-3">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Khalti Text') }} *</h4>

                            </div>
                          </div>
                          <div class="col-lg-6">
                            <textarea class="input-field" name="paypal_text" placeholder="{{ __('Khalti Text') }}">{{ $gs->paypal_text }}</textarea>
...
{{--                          </div>--}}
{{--                          <div class="col-lg-6">--}}
                            <input type="hidden" class="input-field" placeholder="{{ __('Instamojo API Key') }}" name="instamojo_key" value="{{ $gs->instamojo_key }}" required="">
{{--                          </div>--}}
{{--                        </div>--}}
...
{{--                          </div>--}}
{{--                          <div class="col-lg-6">--}}
                            <input type="hidden" class="input-field" placeholder="{{ __('Instamojo Auth Token') }}" name="instamojo_token" value="{{ $gs->instamojo_token }}" required="">
{{--                          </div>--}}
{{--                        </div>--}}
...
{{--                          <div class="col-lg-6">--}}
{{--                            <label class="switch">--}}
                              <input type="hidden" name="instamojo_sandbox" value="1" {{ $gs->instamojo_sandbox == 1 ? "checked":"" }}>
...
{{--                          </div>--}}
{{--                          <div class="col-lg-6">--}}
                            <input type="hidden" class="input-field" placeholder="{{ __('Paystack Public Key') }}" name="paystack_key" value="{{ $gs->paystack_key }}" required="">
{{--                          </div>--}}
{{--                        </div>--}}
...
{{--                          </div>--}}
{{--                          <div class="col-lg-6">--}}
                            <input type="hidden" class="input-field" placeholder="{{ __('Paystack Business Email') }}" name="paystack_email" value="{{ $gs->paystack_email }}" required="">
{{--                          </div>--}}
{{--                        </div>--}}
...
{{--                            </div>--}}
{{--                            <div class="col-lg-6">--}}
                              <input type="hidden" class="input-field" placeholder="{{ __('Paytm Merchant') }}" name="paytm_merchant" value="{{ $gs->paytm_merchant }}" required="">
{{--                            </div>--}}
{{--                          </div>--}}
...
{{--                          </div>--}}
{{--                          <div class="col-lg-6">--}}
                            <input type="hidden" class="input-field" placeholder="{{ __('Paytm Secret') }}" name="paytm_secret" value="{{ $gs->paytm_secret }}" required="">
{{--                          </div>--}}
{{--                        </div>--}}
...
{{--                          </div>--}}
{{--                          <div class="col-lg-6">--}}
                            <input type="hidden" class="input-field" placeholder="{{ __('Paytm Website') }}" name="paytm_website" value="{{ $gs->paytm_website }}" required="">
{{--                          </div>--}}
{{--                        </div>--}}
...
{{--                          </div>--}}
{{--                          <div class="col-lg-6">--}}
                            <input type="hidden" class="input-field" placeholder="{{ __('Paytm Industry') }}" name="paytm_industry" value="{{ $gs->paytm_industry }}" required="">
{{--                          </div>--}}
{{--                        </div>--}}
...
{{--                          <div class="col-lg-6">--}}
{{--                            <label class="switch">--}}
                              <input type="hidden" name="paytm_mode" value="1" {{ $gs->paytm_mode == 'sandbox' ? "checked":"" }}>
{{--                              <span class="slider round"></span>--}}
{{--                            </label>--}}
{{--                          </div>--}}
{{--                          </div>--}}
...
{{--                          </div>--}}
{{--                          <div class="col-lg-6">--}}
                            <input type="hidden" class="input-field" placeholder="{{ __('Withdraw Fee') }}" name="withdraw_fee" value="{{ $gs->withdraw_fee }}" required="">
{{--                          </div>--}}
{{--                        </div>--}}
...
{{--                          </div>--}}
{{--                          <div class="col-lg-6">--}}
                            <input type="hidden" class="input-field" placeholder="{{ __('Withdraw Charge(%)') }}" name="withdraw_charge" value="{{ $gs->withdraw_charge }}" required="">
{{--                          </div>--}}
{{--                        </div>--}}
...
{{--                          </div>--}}
{{--                          <div class="col-lg-6">--}}
                            <input type="hidden" class="input-field" placeholder="{{ __('Tax(%)') }}" name="tax" value="{{ $gs->tax }}" required="">
{{--                          </div>--}}
{{--                        </div>--}}
...
{{--                          </div>--}}
{{--                          <div class="col-lg-6">--}}
                            <input type="hidden" class="input-field" placeholder="{{ __('Fixed Commission') }}" name="fixed_commission" value="{{ $gs->fixed_commission * $curr->value }}" required="">
{{--                          </div>--}}
{{--                        </div>--}}
...
{{--                          </div>--}}
{{--                          <div class="col-lg-6">--}}
                            <input type="hidden" class="input-field" placeholder="{{ __('Percentage Commission') }}" name="percentage_commission" value="{{ $gs->percentage_commission }}" required="">
{{--                          </div>--}}
{{--                        </div>--}}
...
{{--                          <div class="col-lg-6">--}}
{{--                            <label class="switch">--}}
                              <input type="hidden" name="vendor_ship_info" value="1" {{ $gs->vendor_ship_info == 1 ? "checked" : "" }}>
{{--                              <span class="slider round"></span>--}}
{{--                            </label>--}}
{{--                          </div>--}}
{{--                          </div>--}}
