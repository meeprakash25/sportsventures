                            ...
                            <form id="geniusform" action="{{route('admin-role-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-4 d-flex justify-content-between">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" name="section[]" value="sms_settings" {{ $data->sectionCheck('sms_settings') ? 'checked' : '' }}>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                    <div class="col-lg-2"></div>
                                    <div class="col-lg-4 d-flex justify-content-between">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" name="section[]" value="alert_settings" {{ $data->sectionCheck('alert_settings') ? 'checked' : '' }}>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                </div>
