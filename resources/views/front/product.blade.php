                                    ...
                                    <div class="all-slider">
                                        ...
                                        @foreach($productt->galleries as $gal)
                                            ...
                                            <a href="{{asset('public/assets/images/galleries/'.$gal->photo)}}">
                                                <img class="xzoom-gallery5" width="80" src="{{asset('public/assets/images/galleries/'.$gal->photo)}}"
                                                     title="The description goes here">
                                            </a>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="gocover"
                                 style="background: url({{ asset('public/assets/images/'.$gs->loader) }}) no-repeat scroll center center rgba(45, 45, 45, 0.5);"></div>
