...
if (isset($gs->header_color)) {
    $header_color = $gs->header_color;
} else {
    $header_color = '#143250';
}

if (isset($gs->footer_color)) {
    $footer_color = $gs->footer_color;
} else {
    $footer_color = '#143250';
}

if (isset($gs->copyright_color)) {
    $copyright_color = $gs->copyright_color;
} else {
    $copyright_color = '#02020c';
}

if (isset($gs->menu_color)) {
    $menu_color = $gs->menu_color;
} else {
    $menu_color = '#02020c';
}

if (isset($gs->menu_hover_color)) {
    $menu_hover_color = $gs->menu_hover_color;
} else {
