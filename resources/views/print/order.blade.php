                ...
                <div class="table-responsive">
                    <table id="example2" class="table table-hover dt-responsive" cellspacing="0"
                        ...
                        @foreach($cart->items as $product)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>
                                        Price
                                        : {{ App\Models\Currency::where('sign',$order->currency_sign)->first()->sign }}{{ round($product['item']['price'] * $order->currency_value , 2) }}
                                    </p>
                                    <p>
                                ...
                                <td>{{ App\Models\Currency::where('sign',$order->currency_sign)->first()->sign }}{{ round($product['price'] * $order->currency_value , 2) }}
                                </td>
                                @php
                        ...
                        <tr class="semi-border">
                            ...
                            <td>{{ App\Models\Currency::where('sign',$order->currency_sign)->first()->sign }}{{ round($subtotal, 2) }}</td>

                        </tr>
                        @if($order->shipping_cost != 0)
                            <tr class="no-border">
                                <td colspan="1"></td>
                                <td><strong>{{ __('Shipping Cost') }}({{ App\Models\Currency::where('sign',$order->currency_sign)->first()->sign }})</strong></td>
                        ...
                        @if($order->packing_cost != 0)
                            <tr class="no-border">
                                <td colspan="1"></td>
                                <td><strong>{{ __('Packaging Cost') }}({{ App\Models\Currency::where('sign',$order->currency_sign)->first()->sign }})</strong></td>
                        ...
                        @if($order->tax != 0)
                            <tr class="no-border">
                                <td colspan="1"></td>
                                <td><strong>{{ __('TAX') }}({{ App\Models\Currency::where('sign',$order->currency_sign)->first()->sign }})</strong></td>
                        ...
                        @if($order->coupon_discount != null)
                            <tr class="no-border">
                                <td colspan="1"></td>
                                <td><strong>{{ __('Coupon Discount') }}({{ App\Models\Currency::where('sign',$order->currency_sign)->first()->sign }})</strong></td>
                                <td>{{ App\Models\Currency::where('sign',$order->currency_sign)->first()->sign }}{{round($order->coupon_discount, 2)}}</td>
                            </tr>
                        @endif
                        <tr class="final-border">
                            <td colspan="1"></td>
                            <td><strong>{{ __('Total') }}</strong></td>
                            <td>{{ App\Models\Currency::where('sign',$order->currency_sign)->first()->sign }}{{ round($order->pay_amount * $order->currency_value , 2) }}
                            </td>
                        </tr>
